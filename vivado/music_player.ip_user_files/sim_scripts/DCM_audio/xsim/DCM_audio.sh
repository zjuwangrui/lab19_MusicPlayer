...
#
# Script generated by Vivado on Wed May 13 13:58:50 +0800 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DCM_audio.sh
...
#
# Usage        : DCM_audio.sh
#                DCM_audio.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DCM_audio.sh [-reset_run]
#                DCM_audio.sh [-reset_log]
#                DCM_audio.sh [-help]
#
...
# script info
echo -e "DCM_audio.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DCM_audio.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DCM_audio xil_defaultlib.DCM_audio xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DCM_audio -key {Behavioral:sim_1:Functional:DCM_audio} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/program/Xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DCM_audio.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DCM_audio.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DCM_audio.sh [-help]\n\
Usage: DCM_audio.sh [-step]\n\
Usage: DCM_audio.sh [-lib_map_path]\n\
Usage: DCM_audio.sh [-reset_run]\n\
Usage: DCM_audio.sh [-reset_log]\n\
Usage: DCM_audio.sh [-keep_index]\n\
Usage: DCM_audio.sh [-noclean_files]\n\n\
