...
#                script (type 'DCM_audio.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DCM_audio xil_defaultlib.glbl -o DCM_audio_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DCM_audio_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DCM_audio_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DCM_audio_simv.daidir vcs_lib c.obj)
