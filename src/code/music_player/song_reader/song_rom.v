...
module song_rom (		
	...
	//送别
    assign memory[	96	] =	{6'd35, 6'd8}	;	// Note:	3G
	assign memory[	97	] =	{6'd32, 6'd6}	;	// Note:	3E
	assign memory[	98	] =	{6'd35, 6'd6}	;	// Note:	3G
	assign memory[	99	] =	{6'd40, 6'd16}	;	// Note:	4C
	assign memory[	100	] =	{6'd37, 6'd8}	;	// Note:	4A
	assign memory[	101	] =	{6'd40, 6'd8}	;	// Note:	4C
	assign memory[	102	] =	{6'd35, 6'd16}	;	// Note:	3G
	assign memory[	103	] =	{6'd35, 6'd8}	;	// Note:	3G
	assign memory[	104	] =	{6'd28, 6'd6}	;	// Note:	3C
	assign memory[	105	] =	{6'd30, 6'd6}	;	// Note:	3D
	assign memory[	106	] =	{6'd32, 6'd8}	;	// Note:	3E
	assign memory[	107	] =	{6'd30, 6'd6}	;	// Note:	3D
	assign memory[	108	] =	{6'd28, 6'd6}	;	// Note:	3C
	assign memory[	109	] =	{6'd30, 6'd24}	;	// Note:	3D
	assign memory[	110	] =	{6'd0, 6'd8}	;	// Note:	rest
    assign memory[    111    ] =    {6'd35, 6'd8}    ;    // Note:    3G
    assign memory[    112    ] =    {6'd32, 6'd6}    ;    // Note:    3E
	assign memory[	113	] =	{6'd35, 6'd6}	;	// Note:	3G
	assign memory[	114	] =	{6'd40, 6'd12}	;	// Note:	4C
	assign memory[	115	] =	{6'd39, 6'd6}	;	// Note:	4B
	assign memory[	116	] =	{6'd37, 6'd8}	;	// Note:	4A
	assign memory[	117	] =	{6'd40, 6'd8}	;	// Note:	4C
	assign memory[	118	] =	{6'd35, 6'd16}	;	// Note:	3G
	assign memory[	119	] =	{6'd35, 6'd8}	;	// Note:	3G
	assign memory[	120	] =	{6'd30, 6'd6}	;	// Note:	3D
	assign memory[	121	] =	{6'd32, 6'd6}	;	// Note:	3E
	assign memory[	122	] =	{6'd33, 6'd12}	;	// Note:	3F
	assign memory[	123	] =	{6'd15, 6'd6}	;	// Note:	2B
	assign memory[	124	] =	{6'd28, 6'd24}	;	// Note:	3C
	assign memory[	125	] =	{6'd0, 6'd8}	;	// Note:	rest
	assign memory[	126	] =	{6'd37, 6'd8}	;	// Note:	4A
	assign memory[	127	] =	{6'd40, 6'd8}	;	// Note:	4C
endmodule							
